...
@section('content')
    <main class="container">
        ...
        @php
            $content = \App\Models\PageContent::find(4); // ID=4 bo‘yicha ma'lumot olish
            $lang = app()->getLocale();
            $imagePath = $content ? $content->{'image_' . $lang} : '/assets/images/information/1111.png'; // Default rasm
        @endphp

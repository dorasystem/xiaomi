                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 p-4 border-start">
                            ...
                            <div class="">
                                ...
                                <div
                                    class="text-center justify-content-center mb-3 fs-14 p-1 rounded bg-darkgrey border-orange installment-option"
                                    onclick="selectInstallmentOption(this)">
                                    @lang('home.full_payment')
                                </div>
                                <div class="">
                                    <div
                                        class="d-flex gap-2 justify-content-center mb-3 fs-14 p-1 rounded bg-darkgrey price-3 installment-option"
                                        onclick="selectInstallmentOption(this)">
                                        <span class="text-orange">3</span> @lang('home.month') <span
                                            class="text-orange">{{ $variants->first()->price_3 ?? '0' }} UZS</span>
                                    </div>
                                    <div
                                        class="d-flex gap-2 justify-content-center mb-3 fs-14 p-1 rounded bg-darkgrey price-6 installment-option"
                                        onclick="selectInstallmentOption(this)">
                                        <span class="text-orange">6</span> @lang('home.month') <span
                                            class="text-orange">{{ $variants->first()->price_6 ?? '0' }} UZS</span>
                                    </div>
                                    <div
                                        class="d-flex gap-2 justify-content-center mb-3 fs-14 p-1 rounded bg-darkgrey price-12 installment-option"
                                        onclick="selectInstallmentOption(this)">
                                        <span class="text-orange">12</span> @lang('home.month') <span
                                            class="text-orange">{{ $variants->first()->price_12 ?? '0' }} UZS</span>
                                    </div>
                                    <div
                                        class="d-flex gap-2 justify-content-center mb-3 fs-14 p-1 rounded bg-darkgrey price-24 installment-option"
                                        onclick="selectInstallmentOption(this)">
                        ...
                        <div class="d-flex flex-column justify-content-between h-100">
                            ...
                            <div class="row align-items-start mt-2">
                                <div class="col-sm-6 mb-2">
                                    <div
                                        class="phone text-nowrap border-orange rounded text-center px-2 py-1 w-100 mb-1">

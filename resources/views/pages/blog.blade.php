...
<main class="container">
    ...
    <div class="row mt-5">
        <a href="./single-blog.html" class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <img height="220px" class="mb-2 w-100 rounded-top fit-cover" src="./assets/images/blog1.webp" alt="" />
        ...
        <a href="./single-blog.html" class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <img height="220px" class="mb-2 w-100 rounded-top fit-cover" src="./assets/images/blog2.webp" alt="" />
            <div class="text-grey fs-14">Обзоры</div>
            <h6 class="fw-bold">Зимний оазис: обзор Xiaomi Smart Evaporative Humidifier</h6>
            <div class="d-flex align-items-center gap-4 mb-3 fs-14">
                <div class="text-grey">30.09.2024</div>
        ...
        <a href="./single-blog.html" class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <img height="220px" class="mb-2 w-100 rounded-top fit-cover" src="./assets/images/blog3.webp" alt="" />
            <div class="text-grey fs-14">Обзоры</div>
            <h6 class="fw-bold">Зимний оазис: обзор Xiaomi Smart Evaporative Humidifier</h6>
            <div class="d-flex align-items-center gap-4 mb-3 fs-14">
                <div class="text-grey">30.09.2024</div>
        ...
        <a href="./single-blog.html" class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <img height="220px" class="mb-2 w-100 rounded-top fit-cover" src="./assets/images/blog4.webp" alt="" />
            <div class="text-grey fs-14">Обзоры</div>
            <h6 class="fw-bold">Зимний оазис: обзор Xiaomi Smart Evaporative Humidifier</h6>
            <div class="d-flex align-items-center gap-4 mb-3 fs-14">
                <div class="text-grey">30.09.2024</div>
        ...
        <a href="./single-blog.html" class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <img height="220px" class="mb-2 w-100 rounded-top fit-cover" src="./assets/images/blog5.webp" alt="" />
            <div class="text-grey fs-14">Обзоры</div>
            <h6 class="fw-bold">Зимний оазис: обзор Xiaomi Smart Evaporative Humidifier</h6>
            <div class="d-flex align-items-center gap-4 mb-3 fs-14">
                <div class="text-grey">30.09.2024</div>

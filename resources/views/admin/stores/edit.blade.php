...
@section('content')
    <form action="{{ route('stores.update', $store->id) }}" method="POST" enctype="multipart/form-data" novalidate class="needs-validation">
        @csrf
        @method('PUT')
                                            ...
                                            <div class="tab-pane fade show {{ $lang == 'uz' ? 'active' : '' }}" id="{{ $lang }}Content">
                                                <div class="form-group pb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="title_{{ $lang }}" name="title_{{ $lang }}"
                                                           value="{{ old('title_' . $lang, $store['title_' . $lang]) }}" required>
                                                </div>
                                                <div class="form-group pb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="address_{{ $lang }}" name="address_{{ $lang }}"
                                                           value="{{ old('address_' . $lang, $store['address_' . $lang]) }}" required>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="card stretch">
                                ...
                                <div class="card-body p-4">
                                    <div class="form-group pb-3">
                                        ...
                                        <input type="text" class="form-control" id="phone_1" name="phone_1" value="{{ old('phone_1', $store->phone_1) }}">
                                    </div>
                                    <div class="form-group pb-3">
                                        <label for="phone_2">Phone 2:</label>
                                        <input type="text" class="form-control" id="phone_2" name="phone_2" value="{{ old('phone_2', $store->phone_2) }}">
                                    </div>
                                    <div class="form-group pb-3">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <input type="text" class="form-control" id="latitude" name="latitude" value="{{ old('latitude', $store->latitude) }}">
                                    </div>
                                    <div class="form-group pb-3">
                                        <label for="longitude">Longitude:</label>
                                        <input type="text" class="form-control" id="longitude" name="longitude" value="{{ old('longitude', $store->longitude) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
